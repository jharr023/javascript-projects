...
let nonPiracyFunction = function(newArr) {
  if  (cargoHold.includes('gold')) {
    return newArr.push('gold');
    cargoHold.splice(5,1)
    cargoHold.push('fools gold');
  } else if (cargoHold.includes('AE-35 unit')) {
    return newArr.push("AE-35 unit")
    cargoHold.splice(7,1)
    cargoHold.push('broken AE-35');
  }
}
